...
export function ProgressRing({ size = 70, strokeWidth = 4, pct, done, total }) {
...
// ── Phase Progress Bars ──
export function PhaseProgress({ phases, isCompact }) {
  return (
...
export function DateChart({ data, isCompact }) {
  if (!data) return null
